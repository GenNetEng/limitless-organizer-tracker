...
| 25 | Scrape endpoint syncs `first_tournament_date` + returns `estimated_onboard_date` from regression ([#62](https://github.com/GenNetEng/limitless-organizer-tracker/issues/62)) | MVP3 | [#62](https://github.com/GenNetEng/limitless-organizer-tracker/issues/62) |
