...
| FR31 | Recently onboarded organizers table: `RecentlyOnboarded.tsx` displays recently onboarded organizers with datetime timestamps and clickable IDs linking to Organizer Profile section | BR3 | Pending — Phase 41 ([#92](https://github.com/GenNetEng/limitless-organizer-tracker/issues/92)) |
| FR32 | Date window selector on Organizer Activity chart and Wait Time Estimator (30/90/180 days, all time) enabling users to focus on recent trends vs historical data | BR3 | Pending — Phase 41 ([#125](https://github.com/GenNetEng/limitless-organizer-tracker/issues/125)) |
